...
declare function clean<T extends any[] | {
    [key: string]: any;
    [key: number]: any;
 ...
 * @returns 查找的结果
 */
declare function deepFindTreePath(tree: any[], handler: (item: any) => boolean, config: {
    id: string;
    children: string;
}): undefined | any[];
...
/**
   ...
   * @returns 结果
   */
declare function floorFixed(data: number | string, fractionDigits: number, rejection?: boolean): string;
 ...
 * @returns 结果
 */
declare function roundFixed(data: number | string, fractionDigits: number, rejection?: boolean): string;
...
/**
   ...
   * @returns 结果
   */
declare function deepFindItem<T>(list: T[], handle: (data: T) => void, children?: string): T | undefined;
 ...
 * @returns 结果
 */
declare function flatArrayToTree(list: any[], props?: {
    id?: string;
    pid?: string;
    children?: string;
}): any[];
 ...
 *```
 */
declare function timeLine(list: string[], units: [string, string, string, string, string, string, string]): {
    /** 时间刻度文本 */
    label: string;
 ...
 */
declare function forEachTree<T extends IKvPair>(data: T[], handle: (data: T) => void, childKey?: keyof T): void;
...
/**
   ...
   * @returns 分页数据
   */
declare function dataPage<T>(data: T[], pageSize: number, pageCurrent: number): {
    current: number;
    total: number;
    size: number;
    pages: number;
...
/**
   ...
   */
declare function libraryFile(files: LibraryFileConfig | LibraryFileConfig[], callback: SuccessCallback): void;
...
/**
  ...
  *
  */
declare function observeDomResize(element: HTMLElement, handler: (element: HTMLElement) => void, type?: ('width' | 'height' | 'position')[], interval?: number): () => void;
